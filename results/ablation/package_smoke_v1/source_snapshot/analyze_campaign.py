...
- Formal untouched 78-record test available: no
...
These are preliminary one-seed mechanism-screen results on 157 historical validation records. They do not support a final top-journal superiority claim until the missing 78-record formal test, longer training, three seeds, sensor noise/dropout, sensor-count/location ablations and external/experimental bridge data are evaluated.
"""
    (run_root / "ANALYSIS.md").write_text(markdown, encoding="utf-8")
    print(markdown)
    return 0
